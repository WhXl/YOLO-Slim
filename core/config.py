...
__C.TRAIN.INITIAL_WEIGHT        = "./checkpoint/yolov3_test_loss=10.6896.ckpt-50"
...
__C.TEST.WEIGHT_FILE            = "./checkpoint/yolov3_test_loss=10.6896.ckpt-50"
